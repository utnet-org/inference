...
# 启动命令
# GPU：python MiniCPM-V2.6-WebUI.py --device cuda
# 苹果 MPS：PYTORCH_ENABLE_MPS_FALLBACK=1 PYTORCH_MPS_HIGH_WATERMARK_RATIO=0.0 python MiniCPM-V2.6-WebUI.py --device mps
